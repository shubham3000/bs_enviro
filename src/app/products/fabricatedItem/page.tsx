    ...
    <div>
      <HelmetProvider context={helmetContext}>
        <Helmet prioritizeSeoTags>
          <title>Fabricated Item - B S Enviro N Infracon Pvt Ltd</title>
          <meta
            property="og:title"
            content="Fabricated Item - B S Enviro N Infracon Pvt Ltd"
          />
          <meta
            name="description"
          ...
          <link
            rel="canonical"
            href="https://bsenviro.com/products/fabricatedItem"
          />
        </Helmet>
        <Header isWhite={true} />
        <main className="max-w-screen-2xl">
          <ProductHeroBg
            heading="Fabricated Items (FI)"
