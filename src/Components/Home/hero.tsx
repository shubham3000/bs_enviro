      ...
      >
        <div className="container h-full flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center items-center">
            <motion.h1
              className="text-center font-bold text-7xl text-white max-w-7xl"
            ...
            <motion.h3
              className="text-center px-4 mt-12 text-white text-lg md:text-2xl max-w-5xl"
          ...
          <motion.div
            className="absolute bottom-8 text-white font-semibold text-lg flex justify-center items-center gap-2 cursor-pointer"
            style={{ fontFamily: "Montserrat" }}
